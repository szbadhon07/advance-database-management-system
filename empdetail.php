...
<div class="maincontent">
	...
	require_once('index.php');
	 $c = oci_connect("sz","sz","localhost");
	  $sql=oci_parse($c,"select * from emp ");
	  oci_execute($sql) ;
	  ?><table border="1">
	  <center>
				<table border='1' cellpadding='5' cellspacing='0'>
				<tr><td colspan='7' align='CENTER'>Employee List</td></tr>
				<tr>
				<td>Id</td><td>Name</td><td>Job</td><td>salary</td><td>Hire Date</td><td>Commission</td><td>Department no</td>
				</tr>
